...
set_property PACKAGE_PIN n20 [get_ports rx_clk_in]            #rx_clk_in_p        
set_property PACKAGE_PIN u18 [get_ports rx_frame_in]          #rx_frame_in_p

set_property PACKAGE_PIN y19 [get_ports {rx_data_in[0]}]      #rx_data_in_n[0]
set_property PACKAGE_PIN y18 [get_ports {rx_data_in[1]}]      #rx_data_in_p[0]

set_property PACKAGE_PIN w20 [get_ports {rx_data_in[2]}]      #rx_data_in_n[1]
set_property PACKAGE_PIN v20 [get_ports {rx_data_in[3]}]      #rx_data_in_p[1]

set_property PACKAGE_PIN w19 [get_ports {rx_data_in[4]}]      #rx_data_in_n[2]
set_property PACKAGE_PIN w18 [get_ports {rx_data_in[5]}]      #rx_data_in_p[2]

set_property PACKAGE_PIN r17 [get_ports {rx_data_in[6]}]      #rx_data_in_n[3]
set_property PACKAGE_PIN r16 [get_ports {rx_data_in[7]}]      #rx_data_in_p[3]

set_property PACKAGE_PIN v18 [get_ports {rx_data_in[8]}]      #rx_data_in_n[4]
set_property PACKAGE_PIN v17 [get_ports {rx_data_in[9]}]      #rx_data_in_p[4]

set_property PACKAGE_PIN w16 [get_ports {rx_data_in[10]}]     #rx_data_in_n[5]
set_property PACKAGE_PIN v16 [get_ports {rx_data_in[11]}]     #rx_data_in_p[5]

set_property PACKAGE_PIN y17 [get_ports {tx_data_out[0]}]     #tx_data_out_n[0] 
set_property PACKAGE_PIN y16 [get_ports {tx_data_out[1]}]     #tx_data_out_p[0] 

set_property PACKAGE_PIN u15 [get_ports {tx_data_out[2]}]     #tx_data_out_n[1] 
set_property PACKAGE_PIN u14 [get_ports {tx_data_out[3]}]     #tx_data_out_p[1] 

set_property PACKAGE_PIN w15 [get_ports {tx_data_out[4]}]     #tx_data_out_n[2] 
set_property PACKAGE_PIN v15 [get_ports {tx_data_out[5]}]     #tx_data_out_p[2] 

set_property PACKAGE_PIN y14 [get_ports {tx_data_out[6]}]     #tx_data_out_n[3] 
set_property PACKAGE_PIN w14 [get_ports {tx_data_out[7]}]     #tx_data_out_p[3] 

set_property PACKAGE_PIN w13 [get_ports {tx_data_out[8]}]     #tx_data_out_n[4] 
set_property PACKAGE_PIN v12 [get_ports {tx_data_out[9]}]     #tx_data_out_p[4] 

set_property PACKAGE_PIN u12 [get_ports {tx_data_out[10]}]    #tx_data_out_n[5] 
set_property PACKAGE_PIN t12 [get_ports {tx_data_out[11]}]    #tx_data_out_p[5]  

set_property PACKAGE_PIN n18 [get_ports tx_clk_out]           #tx_clk_out_p
set_property PACKAGE_PIN t16 [get_ports tx_frame_out]         #tx_frame_out_p
